...
<template>
  ...
  >
    <div
      ...
      class="h-full flex-grow bg-[#0649B5] hover:w-96 w-0 transition-all flex justify-center items-center flex-col home grayscale hover:grayscale-0"
    >
      <div
        class="p-10 rounded-full flex justify-center items-center border-4 border-white icon-home"
      >
    ...
    <div
      ...
      class="h-full flex-grow bg-[#F15BB5] hover:w-96 w-0 transition-all justify-center items-center flex-col flex info grayscale hover:grayscale-0"
    >
      <div
        class="p-10 rounded-full flex justify-center items-center border-4 border-white icon-info"
      >
    ...
    <div
      ...
      class="h-full flex-grow bg-[#FEB240] hover:w-96 w-0 transition-all justify-center items-center flex-col flex project grayscale hover:grayscale-0"
    >
      <div
        class="p-10 rounded-full flex justify-center items-center border-4 border-white icon-project"
      >
    ...
    <div
      ...
      class="h-full flex-grow bg-[#00BBF9] hover:w-96 w-0 transition-all justify-center items-center flex-col flex contact grayscale hover:grayscale-0"
    >
      <div
        class="p-10 rounded-full flex justify-center items-center border-4 border-white icon-contact"
      >
